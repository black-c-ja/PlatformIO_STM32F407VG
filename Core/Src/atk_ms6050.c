...
#define atk_ms6050_iic_init       MX_IIC_Init
#define atk_ms6050_iic_start     IIC_Start
#define atk_ms6050_iic_stop      IIC_Stop
#define atk_ms6050_iic_send_byte  IIC_SendByte
#define atk_ms6050_iic_wait_ack   IIC_WaitAck
#define atk_ms6050_iic_read_byte  IIC_ReadByte
#define atk_ms6050_iic_ack        IIC_Ack
#define atk_ms6050_iic_nack       IIC_NAck
